...
<section id="main">
	...
	<h1>
		<spring:message code="label.header.editcomputer"></spring:message>
	</h1>

	<form:form commandName="computerEdit" action="EditComputer"
		method="POST">
		...
		<fieldset>
			<div class="clearfix">
				...
				<div class="input">
					<form:input path="name" data-validation="required"
			...
			<div class="clearfix">
				...
				<div class="input">
					<form:input path="introduced" class="datepicker" data-validation="date"
			...
			<div class="clearfix">
				...
				<div class="input">
					<form:input path="discontinued" class="datepicker" data-validation="date"
						data-validation-format="${dateFormat}"
						data-validation-optional="true"
						data-validation-error-msg="Please enter a valide format ${dateFormat}" />
					<span class="help-inline">${dateFormat}</span>
